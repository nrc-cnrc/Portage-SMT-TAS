...
\section{Final Note}
Because of differences in rounding and optimization between systems, results may vary on your platform and are shown in this document only as a reference for the user.
