...
/**
 * Program testphrasefinder's entry point.  Sets up and runs the test.
...
*/
    ...
    // Set each phrase's first word to it's index and put pointers to the phrases into a
    // vector
    vector<PhraseInfo *> **phTArray = CreateTriangularArray<vector<PhraseInfo
	*> >()(SENTLENGTH);
