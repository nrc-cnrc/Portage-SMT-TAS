...
class PLM;
    ...
    protected:
        ...
        /**
         * @brief Produce a copy-as-is hypothesis.
         *
        ...
        /**
         * @brief Future score pre-computation using dynamic programming.
         *
         ...
         *                  source range.
         */
        virtual double **precomputeFutureScores(vector<PhraseInfo *> **phrases, Uint
                sentLength);
    ...
    public:
        ...
        /**
         * @brief Add a text-based TM with forward probs used for pruning only
         *
        ...
        /**
         * @brief Add a text-based translation model without forward probs.
         *
        ...
        /// Whether to use translations from the phrase table in
        /// addition to marked translations.
        bool bypassMarked;
        /// The value to add to each marked translation's log probability.
        double addWeightMarked;
        /// The maximum number of translations per source phrase, or
        /// NO_SIZE_LIMIT if no limit.
        Uint phraseTableSizeLimit;
        /// The probability threshold for phrases in the phrase table,
        /// as a (non-log) probability.
        double phraseTableThreshold;
        /// The maximum distortion length allowed between two phrases.
        int distLimit;
    ...
    public:
        ...
        /**
         * @brief Estimate future score.
         *
         * As with scoreTranslation, calculates the incremental log future
         * probability for trans and the log future probability for
         * *trans.back.
         * @param trans     The translation to score
