...
PortageII Knowledge Prerequisites
---------------------------------

Up link:PortageMachineTranslation.html[PortageII] Previous:
link:PortageIIOverview.html[Background] Next:
...
* Make: PortageII software is built and run using make; you might
...
make. PortageII itself is installed using make and g++ and some
bash scripts you might have to customize. Packages that PortageII
