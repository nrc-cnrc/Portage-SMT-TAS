...
PORTAGE shared, called "PortageLive". The rationale for doing this on
...
needed on the PortageLive server. These include: 1. the PORTAGE shared
...
have the three RPM__s necessary to build your PortageLive Virtual
Appliance.
