...
link:PortageIIAnnotatedBibliography.html#Pauletal2009[Paul
et al 2009]. Virtualization makes it possible to port PortageII to
...
link:PortageIIAnnotatedBibliography.html#Germannetal2009[Germann
