...
paper, adding details about sparse features as included in PortageII
3.0.
...
(link:PortageIIAnnotatedBibliography.html#GalleyandManning2008[Galley
...
it implemented in PortageII 3.0. (See also
link:PortageIIAnnotatedBibliography.html#CherryandFoster2012[Cherry
