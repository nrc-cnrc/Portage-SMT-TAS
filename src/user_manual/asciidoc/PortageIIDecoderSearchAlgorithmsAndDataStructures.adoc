...
PortageII Decoder Search Algorithms And Data Structures
-------------------------------------------------------
...
criteria
(link:PortageIITrainingModels.html#TrainingConstructingModels[here]
is a description of some models); the weights are learned in an
optimization step as described in the
link:PortageIITrainingOptimizingWeights.html#OptimizingWeightsforCanoeDecoding[COW]
section.
