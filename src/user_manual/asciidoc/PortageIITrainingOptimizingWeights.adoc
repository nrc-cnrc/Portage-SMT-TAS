...
See
link:PortageIIOverview.html#DecoderModelTraining[Decoder
...
* link:PortageIIOverview.html#RescoringModelTraining[Rescoring
...
link:PortageIIFileFormats.html#MarkedUpText[translation
...
and link:PortageIIFileFormats.html#AlignedText[aligned].
