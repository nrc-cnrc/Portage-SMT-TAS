...
PortageII Training Optimizing Weights
-------------------------------------
...
PortageII supports a variety of weight tuning algorithms. The old
...
See link:PortageIIOverview.html#truedecoder-model-training[Decoder
...
* link:PortageIIOverview.html#truerescoring-model-training[Rescoring
Model Training] -- detailed description of the algorithm used to learn
rescoring weights,
* `doc/rescoring.README` (or `src/rescoring/README`) -- overview of the
rescoring software, and
* `doc/rescoring_overview.pdf` and `doc/ochlinemax.pdf` --
...
link:PortageIIFileFormats.html#truemarked-up-text[translation
...
and link:PortageIIFileFormats.html#truealigned-text[aligned].
