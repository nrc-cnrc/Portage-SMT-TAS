...
Up: link:PortageMachineTranslation.html[PortageII] Next:
...
http://iit-iti.nrc-cnrc.gc.ca/projects-projets/portage_e.html[public project
page] for a high-level view of the project.
...
commercial releases: PORTAGE__shared__, Portage 1.x, or PortageII.
...
(http://www.statmt.org/wpt05). Results for
...
link:PortageIITextProcessing.html[Text Processing] for a
...
(link:PortageIIAnnotatedBibliography.html#truebrown-et-al-1993[Brown
...
link:PortageIITrainingOtherModels.html#truetranslation-models[Constructing
Translation Models].
...
link:PortageIITrainingLanguageModels.html[Constructing Language Models].
...
link:PortageIIAnnotatedBibliography.html#trueoch-2003[Och 2003].
It is shown in the figure below. To understand the figure, note
...
link:PortageIITrainingOptimizingWeights.html#trueoptimizing-weights-for-canoe-decoding[Optimizing
Weights for Canoe Decoding].
...
link:PortageIITrainingOptimizingWeights.html#trueoptimizing-weights-for-rescoring[Optimizing Weights for Rescoring].
...
(link:PortageIIAnnotatedBibliography.html#truebleu-paper[BLEU
