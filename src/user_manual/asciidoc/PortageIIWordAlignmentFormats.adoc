...
PortageII Word Alignment Formats
--------------------------------

Up: link:PortageMachineTranslation.html[PortageII] Previous:
link:PortageIIFileFormats.html[Text File Formats] Next:
...
When using the framework to train PortageII systems, you will see
...
PortageII phrase extraction process. The `align-words` program can
