...
# COMMENTS:
#
# Groupe de technologies langagieres interactives / Interactive Language Techno ogies Group
...
sub PrintHelp {
print <<'EOF';
  faucet.pl, Copyright (c) 2005 - 2006, Sa Majeste la Reine du Chef du Canada / Her Majesty in Right of Canada
