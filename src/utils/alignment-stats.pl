...
# alignment-stats.pl - produce some statistics that might suggest the quality
# of alignment sentence aligned files.
#
...
print STDERR "alignment-stats.pl, Copyright (c) 2005 - 2006, Conseil national de recherches Canada / National Research Council Canada\n";
