...
class IncrementalTrainor extends PortageLiveLib {
   ...
   protected $source_block = NULL;
   protected $target_block = NULL;
      ...
      foreach ($request as $k => $v) {
         switch($k) {
            ...
            case "document_model_ID":
               ...
               break;
            case "source_block":
               $this->source_block = $this->decodeArgument($v);
               break;
            case "target_block":
               $this->target_block = $this->decodeArgument($v);
               break;
            case "extra":
   ...
   public function addTextBlock() {
      ...
      # We will let PortageLiveLib::incrAddTextBlock()
      # handle its arguments errors.
      $result = $this->incrAddTextBlock(
         $this->context,
...
if (!count(debug_backtrace())) {
   ...
   try {
      ...
      print json_encode($incrementalTrainor->addTextBlock());
   }
