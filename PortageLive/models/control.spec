Summary: This package contains all required models to translate from src_lang to tgt_lang with Portage using context_description.
Name: PortageLive-models-context
Version: 1.0.0.0
Release: 0
License: Copyright © 2004-2012 Her Majesty in Right of Canada. see { commercial, research, evaluation } LICENCE
...
to tgt_lang using Portage 1.5.0 and trained context context_description.
