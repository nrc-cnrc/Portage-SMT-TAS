Summary: This package contains all required models to translate from src_lang to tgt_lang with PortageII using context_description.
...
to tgt_lang using PortageII 2.1 and trained context context_description.
